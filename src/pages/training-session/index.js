...
//=====================================================================================================
    useEffect(() => {
        getConfigTableApi(getNameToId(tableName, 3)).then(r => {
    ...
    }, [listResult.page, listResult.pageSize, refresh, inputSearch])
//=====================================================================================================
    ...
    const deleteTrainingSessionBtn = (e) => {
        setOpenModalDel(true)
        setTrainingSessionId(e)
    }
    const submitDelete = () => {
        if(trainingSessionId){
            deleteTrainingSessionApi(trainingSessionId).then( r => {
...
//=====================================================================================================
    const addTrainingSessionBtn = () => {
        navigate('/training-session/create')
    }
    const updateTrainingSessionBtn = (e) => {
        navigate(`/training-session/update?id=${e}`)
    }
//=====================================================================================================
    const deleteTrainingSessionApi = (data) => {
        return apiTrainingSession.deleteTrainingSession(data);
    }
    const searchTrainingSessionApi = (data) => {
        return apiTrainingSession.searchTrainingSession(data);
    }
                    ...
                    <div className={'form-control-search-header'}>
                        <div className={'flexGroup3'}>
                            <div className={'form-control-search-item'}>
                                <div className={'label-input'}>Tên phiên đào tạo</div>
                                <TextField
                                    size={"small"}
                            ...
                            <Menu
                                ...
                                <SettingColumnTable columns={columns}
                                                    nameTable={getNameToId(tableName,3)}
                                ...
                                ? <Table stickyHeader className={"table-custom"}>
                                    <TableHead className={'super-app-theme--header'}>
                                        <TableRow>
                                            ...
                                            {/*<TableCell style={{minWidth: 200}}>Tên phiên đào tạo</TableCell>*/}
                                            {/*<TableCell style={{minWidth: 200}}>Lớp đào tạo</TableCell>*/}
                                            {/*<TableCell style={{minWidth: 200}}>Thời lượng đào tạo</TableCell>*/}
                                            {/*<TableCell style={{minWidth: 200}}>Thời gian đào tạo</TableCell>*/}
                                            ...
                                            {/*<TableCell style={{minWidth: 200}}>Link hình ảnh</TableCell>*/}
                                        ...
                                        {listResult.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item, i) => (
                                            <>
                                                <TableRow hover role="checkbox" tabIndex={-1}>
                                                    ...
                                                    {/*<TableCell rowSpan={1}>{item.trainingClass.name}</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>{item.trainingDuration}</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>{getDateTimeFromTimestamp(item.trainingTime)}</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>{item.organizationLocation.name}</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>{item.formTraining.name}</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>*/}
                                                    {/*    {item.lecturers.map((cc) => (*/}
                                                    {/*        <p>{cc.name}</p>*/}
                                                    {/*    ))}*/}
                                                    {/*</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>{item.imageLink}</TableCell>*/}
