...
//=====================================================================================================
    useEffect(() => {
        getConfigTableApi(getNameToId(tableName, 4)).then(r => {
...
//=====================================================================================================
    ...
    const updateLinkBtn = (e) => {
        navigate(`/link/update?id=${e}`)
    }
//=====================================================================================================
    const deleteLinkApi = (data) => {
        return apiLink.deleteLink(data);
    }
    const searchLinkApi = (data) => {
        return apiLink.searchLink(data);
    }
                    ...
                    <div className={'form-control-search-header'}>
                        <div className={'flexGroup3'}>
                            <div className={'form-control-search-item'}>
                                <div className={'label-input'}>Tên nguồn đăng ký</div>
                                <TextField
                                    size={"small"}
                            ...
                            <Menu
                                ...
                                <SettingColumnTable columns={columns}
                                                    nameTable={getNameToId(tableName,4)}
                                ...
                                ? <Table stickyHeader className={"table-custom"}>
                                    <TableHead className={'super-app-theme--header'}>
                                        <TableRow>
                                            ...
                                            {/*<TableCell style={{minWidth: 200}}>Tên nguồn đăng ký</TableCell>*/}
                                            {/*<TableCell style={{minWidth: 200}}>Đường dẫn link</TableCell>*/}
                                            {/*<TableCell style={{minWidth: 200}}>Account tạo link</TableCell>*/}
                                            {/*<TableCell style={{minWidth: 200}}>Giới thiệu</TableCell>*/}
                                        ...
                                        {listResult.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item, i) => (
                                            <>
                                                <TableRow hover role="checkbox" tabIndex={-1}>
                                                    ...
                                                    {/*<TableCell rowSpan={1}>{item.path}</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>{item.creator}</TableCell>*/}
                                                    {/*<TableCell rowSpan={1}>{item.introText}</TableCell>*/}
