...
//=====================================================================================================
    ...
    const updateTrainingBtn = (e) => {
        navigate(`/training/update?id=${e}`)
    }
//=====================================================================================================
    const deleteTrainingApi = (data) => {
        return apiTraining.deleteTraining(data);
    }
    const searchTrainingApi = (data) => {
        return apiTraining.searchTraining(data);
    }
                            ...
                            <div className={'main-content-body-search'}>
                                <div className={'form-control-search-header'}>
                                    <div className={'form-control-search-item'}>
                                        <div className={'label-input'}>Tên khóa đào tạo</div>
                                        <TextField
                                            size={"small"}
                            ...
                            <div className={'main-content-body-title flexGroup2'}>
                                ...
                                <Menu
                                    ...
                                    <SettingColumnTable columns={columns}
                                                        nameTable={getNameToId(tableName,1)}
                                            ...
                                            ? <Table stickyHeader className={"table-custom"}>
                                                <TableHead className={'super-app-theme--header'}>
                                                    <TableRow>
                                                        ...
                                                        {/*<TableCell style={{minWidth: 200}}>Tên khóa đào tạo</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Mã khóa đào tạo</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Kế hoạch</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Khối</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Đơn vị</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Thời lượng dự*/}
                                                        {/*    kiến/lớp</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Tổng thời lượng dự*/}
                                                        {/*    kiến</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Học viên dự kiến</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Học viên thực*/}
                                                        {/*    tế/lớp</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Số lượng lớp</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Danh sách giảng*/}
                                                        {/*    viên</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Đối tượng giảng*/}
                                                        {/*    viên</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Đối tượng học*/}
                                                        {/*    viên</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Hình thức đào tạo</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Hình thức thực*/}
                                                        {/*    hiện</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Địa điểm đào tạo</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Đơn giá giảng*/}
                                                        {/*    viên/giờ</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Tổng chi phí giảng*/}
                                                        {/*    viên</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Chi phí hậu cần</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Chi phí ăn trưa</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Tổng chi phí</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Ngày bắt đầu</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 200}}>Ngày kết thúc</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 250}}>Nội dung</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 250}}>Mục tiêu</TableCell>*/}
                                                        {/*<TableCell style={{minWidth: 250}}>Ghi chú</TableCell>*/}

                                                        <TableCell className={'action-header'} style={{minWidth: 50}} align="center">Thao
                                                            tác</TableCell>
                                                    </TableRow>
                                                </TableHead>
                                                            ...
                                                            <TableRow hover role="checkbox" tabIndex={-1}>
                                                                ...
                                                                {columns.map((column, columnIndex) => {
                                                                    if (column.visible) {
                                                                        ...
                                                                        } else if (column.code === 'startDate' || column.code === 'endDate') {
                                                                            return (
                                                                                <TableCell key={columnIndex} rowSpan={1}>
                                                                ...
                                                                {/*<TableCell rowSpan={1}>{item.plan.name}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.blockOrganization.name}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.unitOrganization.name}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{`${item.estimateDurationOfClass} giờ`}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{`${item.totalEstimateDuration} giờ`}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.estimateStudent}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.realStudentOfClass}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.numberOfClasses}</TableCell>*/}
                                                                {/*<TableCell rowSpan={1}>*/}
                                                                ...
                                                                {/*</TableCell>*/}
                                                                {/*<TableCell rowSpan={1}>*/}
                                                                {/*    {item.lecturerObjects.map((cc) => (*/}
                                                                {/*        <p>{cc.name}</p>*/}
                                                                {/*    ))}*/}
                                                                {/*</TableCell>*/}
                                                                {/*<TableCell rowSpan={1}>*/}
                                                                {/*    {item.studentObjects.map((cc) => (*/}
                                                                {/*        <p>{cc.name}</p>*/}
                                                                {/*    ))}*/}
                                                                {/*</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.formTraining.name}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.formOfImplement}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{item.organizationLocation.name}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{formatVND(item.expensePerLecturer)}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{formatVND(item.expenseAllLecturer)}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{formatVND(item.logisticsExpense)}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{formatVND(item.lunchExpense)}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{formatVND(item.totalExpense)}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{getDateTimeFromTimestamp(item.startDate)}</TableCell>*/}
                                                                {/*<TableCell*/}
                                                                {/*    rowSpan={1}>{getDateTimeFromTimestamp(item.endDate)}</TableCell>*/}
                                                                {/*<TableCell rowSpan={1}>{item.content}</TableCell>*/}
                                                                {/*<TableCell rowSpan={1}>{item.target}</TableCell>*/}
