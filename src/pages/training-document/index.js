...
export default function ManageTrainingDocument() {
    ...
    const [trainingDocumentId, setTrainingDocumentId] = React.useState('');
...
//=====================================================================================================
    ...
    const deleteTrainingDocumentBtn = (e) => {
        setOpenModalDel(true)
        setTrainingDocumentId(e)
    }
    const submitDelete = () => {
    ...
    const handleChange = (e) => {
        setDeparmentManage(e.target.value)
    }

//=====================================================================================================
    const addTrainingDocumentBtn = () => {
        navigate('/training-document/create')
    }
    const updateTrainingDocumentBtn = (e) => {
        navigate(`/training-document/update?id=${e}`)
    }
//=====================================================================================================
    const deleteTrainingDocumentApi = (data) => {
        return apiTrainingDocument.deleteTrainingDocument(data);
    }
    const searchTrainingDocumentApi = (data) => {
        return apiTrainingDocument.searchTrainingDocument(data);
    }
//=====================================================================================================
    return (
                ...
                <div className={'main-content-body-search'}>
                    <div className={'form-control-search-header'}>
                        <div className={'form-control-search-item'}>
                            <div className={'label-input'}>Tên tài liệu đào tạo</div>
                            <TextField
                                size={"small"}
                                ...
                                ? <Table stickyHeader className={"table-custom"}>
                                    <TableHead className={'super-app-theme--header'}>
                                        <TableRow>
                                            ...
                                            <TableCell style={{minWidth: 200}}>Tên tài liệu đào tạo</TableCell>
                                            <TableCell style={{minWidth: 200}}>Khóa đào tạo</TableCell>
                                            <TableCell style={{minWidth: 200}}>Kiểu tài liệu</TableCell>
                                            <TableCell style={{minWidth: 250}}>Đường dẫn</TableCell>
                                        ...
                                        {listResult.rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item, i) => (
                                            <>
                                                <TableRow hover role="checkbox" tabIndex={-1}>
                                                    ...
                                                    <TableCell rowSpan={1}>{item.documentType}</TableCell>
                                                    <TableCell rowSpan={1}>{item.documentLink}</TableCell>
