...
export default function CreateUpdateParticipantUnit(props) {
...
//=====================================================================================================
    ...
    function onSubmitFunction(values) {
        ...
        if (!isUpdate) {
            createParticipantUnitApi(formData).then(r => {
                toast.success('Thêm đơn vị tham gia thành công', Utils.options);
                setTimeout(() => {
                    window.location.href = '/participant-unit';
                }, 1100);
            }).catch(e => {
            ...
            if (isUpdate && idUpdate) {
                ...
                updateParticipantUnitApi(formData).then(r => {
                    ...
                    toast.error('Cập nhật đơn vị tham gia không thành công', Utils.options);
                })
            }
        }
    }
...
//=====================================================================================================
    const back = () => {
        navigate('/participant-unit')
    }
//=====================================================================================================
    const createParticipantUnitApi = (data) => {
        return apiParticipantUnit.createParticipantUnit(data);
    }
    const updateParticipantUnitApi = (data, idUpdate) => {
        return apiParticipantUnit.updateParticipantUnit(data, idUpdate);
    }
    const getDetailApi = (idUpdate) => {
        return apiParticipantUnit.getDetailParticipantUnit(idUpdate);
    }
//=====================================================================================================
    return (
        <div className={'main-content'}>
            ...
            <div className={'main-content-body'}>
                <Formik
                    // validationSchema={validationparticipant-unit}
                    enableReinitialize
                    initialValues={{
                            ...
                            <Form onSubmit={handleSubmit}>
                                <Box sx={{flexGrow: 1}} className={'form-content'}>
                                    <Grid container spacing={2.5}>
                                        <Grid item xs={4} md={3}>
                                            <div className={'label-input'}>Tên đơn vị tham gia<span
                                            ...
                                            <TextField
                                                ...
                                                placeholder={'Tên đơn vị tham gia'}
                                                value={values.name}
                                        ...
                                        <Grid item xs={4} md={3}>
                                            <div className={'label-input'}>Đầu mối phối hợp<span
                                                className={'error-message'}>*</span></div>
                                            <TextField
                                                size={"small"}
                                                id='clue'
