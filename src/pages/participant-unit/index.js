...
export default function ManageParticipantUnit() {
    ...
    const [participantUnitId, setParticipantUnitId] = React.useState('');
...
//=====================================================================================================
    ...
    const deleteParticipantUnitBtn = (e) => {
        setOpenModalDel(true)
        setParticipantUnitId(e)
    }
    const submitDelete = () => {
        if(participantUnitId){
            deleteParticipantUnitApi(participantUnitId).then( r => {
...
//=====================================================================================================
    const addParticipantUnitBtn = () => {
        navigate('/participant-unit/create')
    }
    const updateParticipantUnitBtn = (e) => {
        navigate(`/participant-unit/update?id=${e}`)
    }
//=====================================================================================================
    const deleteParticipantUnitApi = (data) => {
        return apiParticipantUnit.deleteParticipantUnit(data);
    }
    const searchParticipantUnitApi = (data) => {
        return apiParticipantUnit.searchParticipantUnit(data);
    }
//=====================================================================================================
    return (
                ...
                <div className={'main-content-body-search'}>
                    <div className={'form-control-search-header'}>
                        <div className={'form-control-search-item'}>
                            <div className={'label-input'}>Tên đơn vị tham gia</div>
                            <TextField
                                size={"small"}
